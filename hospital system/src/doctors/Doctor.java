...
public class Doctor extends JFrame {
	 ...
	 * Create the frame.
	 */
	public Doctor(String name,String spc) {
		this.name = name;
		this.spc = spc;
		...
		mntmPatientRegisrations.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				new Patient(Doctor.this.name,Doctor.this.spc).setVisible(true);
				dispose();
		...
		mntmDoctorInformation.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				new Doctor(Doctor.this.name,Doctor.this.spc).setVisible(true);				
				dispose();
			}
		});
		...
		mntmPatientStatus.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				new PatientStatus(Doctor.this.name,Doctor.this.spc).setVisible(true);	
				dispose();
			}
		});
		...
		mntmMedicamentInformation.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				new Medical(Doctor.this.name,Doctor.this.spc).setVisible(true);
				dispose();
			}
		});
		...
		mntmInvestigationType.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				new investigation(Doctor.this.name,Doctor.this.spc).setVisible(true);
				dispose();
			}
		});
		...
		mntmNurseInformation.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				new NursInfo(Doctor.this.name,Doctor.this.spc).setVisible(true);
				dispose();
			}
		});
		...
		mntmPatientReport.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				new Report(Doctor.this.name,Doctor.this.spc).setVisible(true);
				dispose();
			}
		});
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				else
				{
					...
					try
					{
		                ...
		                if (val == 0)
		                {
		                	 String sql_delete="delete from doctor_information where ssn='" + txtId.getText() + "'";
							 SQLCon.SQLConn(sql_delete);
							 ResultSet rs = SQLCon.SQLConnection("select * from doctor_information");
							 tableInfo.setModel(DbUtils.resultSetToTableModel(rs));
							 
							 sql_delete="delete from doctor_schedule where ssn='" + txtId.getText() + "'";
							 SQLCon.SQLConn(sql_delete);
							 rs = SQLCon.SQLConnection("select * from doctor_schedule");
		...
		btnDadysDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				 int val = JOptionPane.showConfirmDialog(null, "Do you realy want to delete");
	                if (val == 0)
	                {
	                	String sql_delete="delete from doctor_schedule where ssn='" + txtId.getText() + "'";
	    		     	SQLCon.SQLConn(sql_delete);
	    			    ResultSet rs = SQLCon.SQLConnection("select * from doctor_schedule");
	    				tableDays.setModel(DbUtils.resultSetToTableModel(rs));
	    				txtId.setText("");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
                    ...
                    {
                    	//String sql_add= "insert into doctor_information(ssn,name,phone,data_of_birth,blood_group,e_mail,website,address,department,qualification,academics) values('"+txtId.getText().toString()+"','"+ txtFirstName.getText().toString() + "','" + txtPhone.getText().toString() + "','" + comYear.getSelectedItem().toString()+ "','"+ comBlood.getSelectedItem().toString() +"','"+txtEmail.getText().toString()+"','"+txtWebsite.getText().toString()+"','"+txtAddress.getText().toString()+"','"+comDepartement.getSelectedItem().toString()+"','"+txtQualification.getText().toString()+"','"+txtAcademies.getText().toString()+"')";
